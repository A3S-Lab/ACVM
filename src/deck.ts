...
export const navigation = [
  ...
  },
  {
    ...
    question: '一笔真实 AI 订单怎样从找服务走到验收、付款和记账？',
    bridge: '答案不是一个模块，而是一条可以逐步检查的任务链。',
    screens: ['system-architecture', 'ans', 'agentic-contract', 'fog-inference', 'poi-proof', 'poi-consensus'],
  },
  {
    key: 'feasibility',
    ...
    question: '结果不能全网重跑时，怎样验收、部署并控制作弊？',
    bridge: '流程能跑之后，只剩三个硬问题：怎么验、怎么接、怎么防刷。',
    screens: ['verification-engine', 'deployment-modes', 'security-boundaries'],
  },
  {
    key: 'economy',
    id: 'economy-roles',
